      ...
      <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-900 text-white p-6 sm:p-8 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
          ...
          <div className="flex flex-wrap gap-2 shrink-0">
            <span className="text-xs text-blue-200 w-full font-semibold">
            ...
            {samplePrescriptionTexts.map((sample, idx) => (
              <button
                ...
                className="bg-white/10 hover:bg-white/20 text-white text-xs px-3 py-1.5 rounded-lg border border-white/20 transition-all"
              >
                Sample {idx + 1}
              </button>
            ))}
